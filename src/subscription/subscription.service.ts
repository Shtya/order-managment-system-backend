...
export class SubscriptionsService {
  ...
  async get(me: User, id: string) {
    ...
    if (!subscription) {
      throw new NotFoundException(
        this.translations.t("domains.subscriptions.subscription_not_found"),
      );
    }
    ...
    if (this.isAdmin(me)) {
      ...
      throw new ForbiddenException(
        this.translations.t("domains.subscriptions.not_your_subscription"),
      );
    }
  ...
  async updateSubscriptionStatus(
    ...
    if (!this.isSuperAdmin(me)) {
      throw new ForbiddenException(
        this.translations.t("domains.subscriptions.permission_required"),
      );
    }
  ...
  async createSubscription(me: User, dto: CreateSubscriptionDto) {
    ...
    return await this.dataSource.transaction(async (manager) => {
      ...
      if (!user) {
        throw new NotFoundException(
          this.translations.t("common.user_not_found"),
        );
      }
      ...
      if (!plan) {
        throw new NotFoundException(
          this.translations.t("common.plan_not_found"),
        );
      }

      if (!plan.isActive) {
        throw new BadRequestException(
          this.translations.t("common.plan_not_active"),
        );
      }
      ...
      const subscription = manager.create(Subscription, {
        ...
        shippingCompaniesLimit:
          dto.shippingCompaniesLimit ?? plan.shippingCompaniesLimit,
      ...
      if (!paymentMethod || dto.price === undefined) {
        throw new BadRequestException(
          this.translations.t(
            "domains.subscriptions.payment_method_and_amount_required",
          ),
        );
      }
    ...
    return await this.dataSource.transaction(async (manager) => {
      ...
      if (dto.planId && dto.planId !== sub.planId) {
        ...
        if (!newPlan || !newPlan.isActive) {
          throw new BadRequestException(
            this.translations.t(
              "domains.subscriptions.new_plan_invalid_or_inactive",
            ),
          );
        }
        ...
        sub.shippingCompaniesLimit =
          dto.shippingCompaniesLimit ?? newPlan.shippingCompaniesLimit;
        ...
        if (dto.includedOrders !== undefined) {
          sub.includedOrders = dto.includedOrders;
        }
        if (dto.extraOrderFee !== undefined) {
          sub.extraOrderFee = dto.extraOrderFee;
        }
        ...
        if (dto.shippingCompaniesLimit !== undefined) {
          sub.shippingCompaniesLimit = dto.shippingCompaniesLimit;
        }
      ...
      if (
        ...
        if (existingActive && existingActive.id !== sub.id) {
          throw new BadRequestException(
            this.translations.t(
              "domains.subscriptions.another_active_subscription_exists",
            ),
          );
        }
      }
  ...
  async cancelSubscription(user: User, subscriptionId: string) {
    return await this.dataSource.transaction(async (manager) => {
      ...
      if (!subscription) {
        throw new BadRequestException(
          this.translations.t("domains.subscriptions.no_active_subscription"),
        );
      }
  ...
  async exportSubscriptions(me: User, q?: any) {
    ...
    worksheet.columns = [
      ...
      {
        header: this.translations.t("common.plan_name"),
        key: "planName",
        width: 20,
      },
      {
        header: this.translations.t("common.plan_type"),
        key: "planType",
        width: 15,
      },
      { header: this.translations.t("common.price"), key: "price", width: 15 },
      {
        header: this.translations.t("common.duration"),
        key: "duration",
        width: 15,
      },
      {
        header: this.translations.t("common.extra_order_fee"),
        key: "extraOrderFee",
        width: 20,
      },
      {
        header: this.translations.t("common.used_orders"),
        key: "usedOrders",
        width: 15,
      },
      {
        header: this.translations.t("common.included_orders"),
        key: "includedOrders",
        width: 15,
      },
      {
        header: this.translations.t("common.users_limit"),
        key: "usersLimit",
        width: 15,
      },
      {
        header: this.translations.t("common.stores_limit"),
        key: "storesLimit",
        width: 15,
      },
      {
        header: this.translations.t("common.shipping_companies_limit"),
        key: "shippingLimit",
        width: 15,
      },
      {
        header: this.translations.t("common.bulk_uploads"),
        key: "bulkUpload",
        width: 15,
      },
      {
      ...
      {
        header: this.translations.t("common.start_date"),
        key: "startDate",
        width: 15,
      },
      {
        header: this.translations.t("common.end_date"),
        key: "endDate",
        width: 15,
      },
    ];
    ...
    const rows = subscriptions.map((sub) => {
      let durationText = sub.duration || this.translations.t("common.monthly");
      ...
      let extraFeeText = this.translations.t("common.not_allowed");

      if (sub.extraOrderFee === 0) {
        extraFeeText = this.translations.t("common.free_excess");
      } else if (Number(sub.extraOrderFee) > 0) {
        extraFeeText = this.translations.t("common.extra_order_fee_per_order", {
          args: {
      ...
      return {
        ...
        planType:
          sub.planType || this.translations.t("common.not_available_symbol"),
