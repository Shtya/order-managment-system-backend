import { AiProgressEvent, AiExecutionSession, AiUsage } from '../interfaces/ai-types';
...
export class AiToolContext {
	...
	constructor(options: { session: AiExecutionSession; requestId: string; allowedToolNames?: string[] }) {
