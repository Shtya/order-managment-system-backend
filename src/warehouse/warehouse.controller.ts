...
export class WarehousesController {
	...
	@Permissions('warehouses.read')
	async exportLocations(@Req() req: any, @Query() q: any, @Res() res: Response) {
	...
	createLocation(@Req() req: any, @Param("warehouseId") warehouseId: string, @Body() dto: CreateStorageLocationDto) {
	...
	removeLocation(@Req() req: any, @Param("warehouseId") warehouseId: string, @Param("locationId") locationId: string) {
		return this.wh.removeLocation(req.user, warehouseId, locationId);
	}

	@Permissions("warehouses.locations.update")
	@Post(":warehouseId/locations/:locationId/toggle-status")
	toggleLocationStatus(@Req() req: any, @Param("warehouseId") warehouseId: string, @Param("locationId") locationId: string) {
