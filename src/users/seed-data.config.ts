export const SEED_DATA = {
  ...
  supplier: {
    ...
    address: "القاهرة، مصر",
    description:
      "شركة توريد متعددة الأقسام توفر منتجات متنوعة للتجار والمتاجر الإلكترونية",
  },
  products: [
    {
      ...
      description:
        "ساعة ذكية رياضية تدعم قياس نبضات القلب والخطوات والإشعارات.",
...

    {
      ...
      description:
        "شنطة ظهر عملية مناسبة للعمل والسفر وتحمل لابتوب حتى 15.6 بوصة.",
